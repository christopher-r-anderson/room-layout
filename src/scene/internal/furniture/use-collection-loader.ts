...
//
// This is a hook rather than a component because it renders nothing - it is effect
// only. It must run inside the Canvas: configuring KTX2 needs the WebGLRenderer.
