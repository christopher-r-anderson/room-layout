...
import { useEditorOverlayProps } from './use-editor-overlay-props'
...
describe('useEditorOverlayProps', () => {
  it('maps granular inputs into the expected overlay prop groups', () => {
    ...
    const { result } = renderHook(() => useEditorOverlayProps(options))
  ...
  it('keeps grouped prop references stable when inputs are unchanged', () => {
    ...
    const { result, rerender } = renderHook(
      ({ nextOptions }) => useEditorOverlayProps(nextOptions),
      {
