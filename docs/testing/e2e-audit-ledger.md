...
| `feedback-routing.spec.ts`                | genuine-e2e           | Pins the event-class → surface routing policy in the real DOM (fired surface AND silent surfaces). Normative twin of `docs/architecture/feedback.md` + `core/feedback/feedback.test.ts`; the three change together.                                                                                                                                                              |
