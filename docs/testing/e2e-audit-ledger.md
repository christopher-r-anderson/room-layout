...
| `feedback-routing.spec.ts`                | genuine-e2e           | Pins the event-class → surface routing in the real DOM (fired surface AND silent surfaces); unit twin `core/stores/feedback-store.test.ts`.                                                                                                                                                                                                                                      |
