...
| core/stores/feedback-store.test.ts                 | keep    | The routing contract (per entry point: fired surface AND silent surfaces) plus the announcer mechanics (nonce re-announce, movement debounce, reset). Normative twin of docs/architecture/feedback.md + e2e/feedback-routing.spec.ts.                                                                                                    |
