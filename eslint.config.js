...
const SCENE_ALLOWED_RUNTIME_IMPORTS =
  'scene-commands$|scene\\.types$|collection-registry$|collection-loader$'
        ...
        'error',
        {
          patterns: [
            ...
            },
            {
              ...
              message:
                'src/core must not reach into scene internals; use the scene public surface (scene-commands, scene.types, collection-registry, collection-loader, scene-test-support).',
            },
            {
              group: RUNTIME_TEST_IMPORT_GROUP,
              message: 'Runtime code must not import from src/test.',
